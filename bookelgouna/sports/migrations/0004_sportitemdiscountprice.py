...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sports', '0003_auto_20150618_1257'),
    ]

    operations = [
        migrations.CreateModel(
            name='SportItemDiscountPrice',
            fields=[
                ...
                ('item', models.ForeignKey(related_name='discount_prices', verbose_name='Sport Item', to='sports.SportItem')),
            ],
            options={
