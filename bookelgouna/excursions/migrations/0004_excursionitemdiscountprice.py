...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('excursions', '0003_auto_20150618_1257'),
    ]

    operations = [
        migrations.CreateModel(
            name='ExcursionItemDiscountPrice',
            fields=[
                ...
                ('item', models.ForeignKey(related_name='discount_prices', verbose_name='Excursion Item', to='excursions.ExcursionItem')),
            ],
            options={
