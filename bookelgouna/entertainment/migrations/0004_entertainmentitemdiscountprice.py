...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('entertainment', '0003_auto_20150618_1257'),
    ]

    operations = [
        migrations.CreateModel(
            name='EntertainmentItemDiscountPrice',
            fields=[
                ...
                ('item', models.ForeignKey(related_name='discount_prices', verbose_name='Entertainment Item', to='entertainment.EntertainmentItem')),
            ],
            options={
